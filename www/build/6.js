...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__accueil__ = __webpack_require__(282);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_text_to_speech__ = __webpack_require__(197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccueilPage = /** @class */ (function () {
    function AccueilPage(navCtrl, navParams, platform, tts /*, public speechRecognition: SpeechRecognition*/, cd, sc) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.platform = platform;
        this.tts = tts; /*, public speechRecognition: SpeechRecognition*/
        this.cd = cd;
        this.sc = sc;
        this.question = "";
        this.lowerq = "";
        ...
        platform.ready().then(function () {
            ...
            //this.speechRecognition.isRecognitionAvailable().then((available: boolean) => this.isSpeechAvailable = available);
            //Mot de bienvenue
            var options = {
                text: _this.rep,
                locale: 'fr-FR',
    ...
    AccueilPage.prototype.reponse = function () {
        ...
        if (this.question == "" || this.question.toLowerCase().search(/bonjour/gi) != -1 || this.question.toLowerCase().search(/salut/gi) != -1 || this.question.toLowerCase().search(/salam/gi) != -1)
            ...
            this.rep = "Vous ne vous en rappelerez pas des propos de Dieu et vous vous en écarteriez.";
        }
            ...
            this.rep = "Quiconque ne craignant pas Allah périra dans le grand Feu*.";
        }
    ...
    AccueilPage.prototype.getPermissions = function () {
        /*this.speechRecognition.hasPermission().then((hasPermission: boolean) => {
          if(!hasPermission) this.speechRecognition.requestPermission;
        })*/
    };
    AccueilPage.prototype.startListening = function () {
        ...
        /* let option = {
           language: 'fr-FR',
           matches: 5,
           prompt: 'Je vous écoute !', //android
           showPopup: true, //android
